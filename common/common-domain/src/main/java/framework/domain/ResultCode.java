...
//400
     ...
     * ⽆效的参数
     */
    INVALID_PARA (400000, "⽆效的参数"),
    /**
     * ⽆效的验证码
     */
    INVALID_CODE (400001, "⽆效的验证码"),
    /**
     * 错误的验证码
     */
     ...
     * ⼿机号格式错误
     */
    ERROR_PHONE_FORMAT (400003, "⼿机号格式错误"),
    /**
     * 超过每⽇发送次数限制
     */
    SEND_MSG_OVERLIMIT (400004, "超过每⽇发送次数限制"),
    /**
     * ⽆效的区划
     */
    INVALID_REGION (400005, "⽆效的区划"),
    /**
     * 参数类型不匹配
     */
    PARA_TYPE_MISMATCH (400006, "参数类型不匹配"),
    USER_DISABLE (400007, "账号已停⽤，登录失败"),
//401
    /**
     * 令牌不能为空
     */
...
//405
     ...
     * 请求⽅法不⽀持！
     */
    REQUEST_METNHOD_NOT_SUPPORTED (405000, "请求⽅法不⽀持"),
     ...
     * 上传oss异常，请稍后重试
     */
    OSS_UPLOAD_FAILED (500004, "上传oss异常，请稍后重 试"),
/**
 * 获取地图数据失败，请稍后重试
 */
 ...
 */
    ...
    MAP_NOT_ENABLED (500008, "地图特性未开启,开启⽅式参考 使⽤⼿册"),
/**
 * 地图区划特性未开启
 */
    MAP_REGION_NOT_ENABLED (500009, "地图区划特性未开启, 开启⽅式参考使⽤⼿册"),
//---------------------枚举占位
/**
 * 占位专⽤
 */
    RESERVED (99999999, "占位专⽤");
    /**
     * 响应码
     */
    private int code;
